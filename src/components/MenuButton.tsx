...
const MenuButton: Component = () => {
  ...
  onMount(() => {
    setTimeout(() => {
      tl = timeline({ defaults: { ease: "power2.inOut" } });
      set("#theBurger", { autoAlpha: 1 });
      set(`.${styles.buns}`, { drawSVG: "0% 30%" });
      set(`.${styles.letters}`, { drawSVG: "53.5% 100%", x: -155 });

      tl.to(`.${styles.patty}`, { duration: 0.35, drawSVG: "50% 50%" }, 0);
      tl.to(
        `.${styles.patty}`,
        { duration: 0.1, opacity: 0, ease: "none" },
        0.25
      );
      tl.to(`.${styles.buns}`, { duration: 0.85, drawSVG: "69% 96.5%" }, 0);
      tl.to(
        `.${styles.letters}`,
        { duration: 0.85, drawSVG: "0% 53%", x: 0 },
        0
      );
  ...
  return (
    ...
    >
      ...
      <g
        ...
        stroke-width="10"
      >
        <line class={styles.patty} x1="50" y1="61" x2="150" y2="61" />
        <path
          class={styles.buns}
